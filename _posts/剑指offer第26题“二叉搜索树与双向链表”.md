...
***
## 思路
二叉搜索树要变成一个有序的序列。二叉搜索树的中序遍历序列，就是一个有序序列，所以我们可以直接通过中序遍历来做。
先找到最左边的节点，并赋值给head，用来返回。然后和它的根节点互联，接下来的所有节点都与前面的节点互联即可。
用stack要写import java.util.Stack;开始忘了，导致编译错误。
## Java实现
```
/*
